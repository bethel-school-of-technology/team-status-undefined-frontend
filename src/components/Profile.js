...
function Profile() {
    ...
    /* Edit, Add, and Delete buttons - Only shows when barber is signed up */
            ...
            return (
                <>
                    <div className="editButtonPosition">
                        ...
                        <Button id="deleteButton" onClick={handleDeleteBarber.bind(this, oneBarber.barberId)}>
                            {" "}
                            DELETE PROFILE
                        </Button>
    ...
    return (
        <>
            ...
            {/* Description Card*/}
            <div className="cater">
                <img src={profilePic} alt="" id="test" height="350px" width="350px" />
